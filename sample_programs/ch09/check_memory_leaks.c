/*
    Taken from:
    https://github.com/nlsandler/writing-a-c-compiler-tests/blob/main/tests/chapter_9/valid/stack_arguments/test_for_memory_leaks.c

    Make sure stack arguments are deallocated correctly after returning from a function call;
    also test passing variables as stack arguments
*/
